...
ASSETS_PATH = OUTPUT_PATH / Path(r"C:\Users\user\Desktop\figmas\build\build\assets\examin_skin_imgs")
...
image_image_1 = PhotoImage(
    file=r"C:\Users\user\Desktop\figmas - Copy\build_all\assets\ex_skin_frame\image_1.png")
...
#     model_path = "D:/best.pt"
    ...
    if len(pred) > 0:
        ...
        with open('shared_data_skin.json', 'w') as file:
            json.dump(data_skin, file)
...
def gen_rep():
    ...
    if documents:
        script_path = r"examin_rep_skin.py"
        subprocess.Popen(['python', script_path], creationflags=subprocess.CREATE_NEW_CONSOLE)
        window.destroy()
