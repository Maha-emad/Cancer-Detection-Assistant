...
# print(examin_Pbs.p_id)
# print(examin_Pbs.pred_set) 
...
if 'Malignant' in prd_set: 
            m_lbl=Label(text=malig_txt,font=("times new roman",12,"bold"),bg='#BABDC5', justify='left',anchor='w')
            m_lbl.place(x=nw_x , y = nw_y) 
            nw_y+=100
if 'Benign' in prd_set : 
            b_lbl=Label(text=begnin_txt,font=("times new roman",12,"bold"),bg='#BABDC5', justify='left',anchor='w')
